...
/**
 * 
 * @Description	分区消费,实现复杂
 * @ClassName	PartitionConsumerTest
 * @Date		2016年8月16日 下午3:15:40
...
public class PartitionConsumerTest {
	...
	public static void main(String args[]) {
        ...
        String topic = "test_tydc_call_coll";
        args = new String[1]; 
        args[0]="6";
		if(args.length < 1){
		...
		String hosts="f6n13511,f6n13710,f6n13501,f6n13711,f6n13610";
		...
		for(int index=0;index < partLen;index++){
	        try {
		     //   SimpleConsumer consumer = new SimpleConsumer(leadBroker, a_port, 100000, 64 * 1024, clientName);
	        	...
	        	//long readOffset = getLastOffset(consumer,topic, index, kafka.api.OffsetRequest.EarliestTime(), clientName);
